    ...
    return {
      tableLists: [
        ...
        },
        {
          ...
          detail: '<h4><b>想要改變好困難，人生好絕望？</b></h4><br><b>那麼您可以試試看以下幾種方法：</b><br><br>一、番茄工作法：<br>番茄工作法的五步驟：<br>Step01、決定待完成的任務<br>Step02、設定番茄工作法定時器至 n 分鐘（通常為25分鐘）。<br>Step03、持續工作直至定時器提示,記下一個番茄。<br>Step04、短暫休息3-5分鐘。<br>Step05、每四個番茄，休息15-30分鐘。<br><br>您可以嘗試把自己的目標以天為單位的計畫，並套用番茄工作法將一天使用數位產品的時間切割，依據個人規劃需求，每隔一段時間更新任務，以維持不脫序的使用習慣。<br><br>二、數位健康：<br>數位健康是已上市的APP，能查看每日3C產品的使用習慣，並量化自己的使用習慣，有助於追蹤個人習慣，是整理和分析個人使用習慣的好幫手。<br><br>三、門診服務：<br>孤立無援毫無頭緒時，可以嘗試尋求門診服務。當你走進大醫院不確定該卦甚麼科時，可以先去家醫科掛號，問診後將會協助您前往適合的門診。當醫生提供專業建議後，會更清楚自己能如何做出改善。<br><br>四、親友的陪伴：<br>嘗試與家人和朋友聊聊你的難處或是邀請親友監督你執行計畫、相約完成目標，而他們的陪伴與支持將會成為你努力改變的一大動力。',
          show: false,
          isFullWindow: false,
        },
      ],
